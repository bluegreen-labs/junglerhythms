...
```{r label="original", echo=FALSE, fig.cap="Orignal sheet with summary data"}
knitr::include_graphics("https://raw.githubusercontent.com/khufkens/junglerhythms/master/vignettes/images/sheet.jpg")
```
