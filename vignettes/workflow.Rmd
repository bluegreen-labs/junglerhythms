...
knitr::include_graphics(here::here("vignettes/images/outline.png"))
```
...
knitr::include_graphics(here::here("vignettes/images/single_year.jpg"))
```
...
knitr::include_graphics(here::here("vignettes/images/polygon.png"))
```
