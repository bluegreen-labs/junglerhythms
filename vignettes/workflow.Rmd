...
knitr::include_graphics("vignettes/images/outline.png")
```
...
knitr::include_graphics("vignettes/images/single_year.png")
```
...
knitr::include_graphics("vignettes/images/polygon.png")
```
