...
standlevel_phen_plotlevel <- function(
  ...
  if(!is_empty(species_list_turn)){
    ...
    final_LT_plot <- data.frame(Plot = rep(c("MIX2","MIX3","MIX4","MIX5","MIX6"),48),
                                week = rep(c(1:48),5),
                                ss_turn = NA)
  }
  #-----------------------------------------------------------------------
  ...
  if(!is_empty(species_list_dorm)){
    ...
    final_LD_plot <- data.frame(Plot = rep(c("MIX2","MIX3","MIX4","MIX5","MIX6"),48),
                                week = rep(c(1:48),5),
                                ss_dorm = NA)
  }
  #-----------------------------------------------------------------------
  ...
  if(!is_empty(species_list_dorm)) {
    ...
    final_flush_plot <- data.frame(Plot = rep(c("MIX2","MIX3","MIX4","MIX5","MIX6"),48),
                                   week = rep(c(1:48),5),
                                   ss_flush = NA)
  }
  #-----------------------------------------------------------------------
  ...
  combined <-  data.frame(Plot = rep(c("MIX2","MIX3","MIX4","MIX5","MIX6"),48),
                          week = rep(c(1:48),5),
                          full_range = NA)
