...
# AUC(standlevel_full$week, standlevel_full$ss_turn, method="step")
# AUC(standlevel_full$week, standlevel_full$ss_dorm, method="step")
...
p_combined_all <- ggplot() +
  ...
  annotate("text", x = 37.6, y = 1.55, label = "140 species\n96.0% BA", family = "Lato", color = "#22211d", hjust = 0) +
...
p_all <- grid.arrange(p_combined_all, p_tmax, p_sun, p_precip, heights = c(4,1.2,1.2,4))

ggsave("manuscript/leaf_phenology/figures/Pierlot_fig4.png", p_all,
       device = "png", width = 4.5, height = 6.3)
