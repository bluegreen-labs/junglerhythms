...
tseries$ccf_dormancy_precip_lead <- paste(round(tseries$ccf_dormancy_precip_lead, digits=3),
                                          " (",tseries$ccf_dormancy_precip_lead_timing,")", sep="")
tseries$ccf_dormancy_precip_lead <- ifelse(tseries$ccf_dormancy_precip_lead %in% "NA (NA)", "-",tseries$ccf_dormancy_precip_lead)

tseries$ccf_dormancy_precip_lag <- paste(round(tseries$ccf_dormancy_precip_lag, digits=3),
                                         " (",tseries$ccf_dormancy_precip_lag_timing,")", sep="")
tseries$ccf_dormancy_precip_lag <- ifelse(tseries$ccf_dormancy_precip_lag %in% "NA (NA)", "-",tseries$ccf_dormancy_precip_lag)

tseries$ccf_dormancy_anom_lead <- paste(round(tseries$ccf_dormancy_anom_lead, digits=3),
                                        " (",tseries$ccf_dormancy_anom_lead_timing,")", sep="")
tseries$ccf_dormancy_anom_lead <- ifelse(tseries$ccf_dormancy_anom_lead %in% "NA (NA)", "-",tseries$ccf_dormancy_anom_lead)

tseries$ccf_turnover_precip_lead <- paste(round(tseries$ccf_turnover_precip_lead, digits=3),
                                          " (",tseries$ccf_turnover_precip_lead_timing,")", sep="")
tseries$ccf_turnover_precip_lead <- ifelse(tseries$ccf_turnover_precip_lead %in% "NA (NA)", "-",tseries$ccf_turnover_precip_lead)

tseries$ccf_turnover_precip_lag <- paste(round(tseries$ccf_turnover_precip_lag, digits=3),
                                         " (",tseries$ccf_turnover_precip_lag_timing,")", sep="")
tseries$ccf_turnover_precip_lag <- ifelse(tseries$ccf_turnover_precip_lag %in% "NA (NA)", "-",tseries$ccf_turnover_precip_lag)

tseries$ccf_turnover_anom_lead <- paste(round(tseries$ccf_turnover_anom_lead, digits=3),
                                        " (",tseries$ccf_turnover_anom_lead_timing,")", sep="")
tseries$ccf_turnover_anom_lead <- ifelse(tseries$ccf_turnover_anom_lead %in% "NA (NA)", "-",tseries$ccf_turnover_anom_lead)
...
#--------------------------------------------------------------------
#--------------------------------------------------------------------
table2 <- overview[,c(1:3,6,10:25)]
table2 <- table2[c("deciduousness",
                   "species_full",
                   "nr_indiv",
                   "site_years",
...
write.table(table2, "data/SI_table2.csv",
            ...
            sep = ",")
#--------------------------------------------------------------------
table2_dormancy <- table2[,c(1:4,5:12)]
...
write.table(table2_dormancy, "data/SI_table2_dormancy.csv",
            ...
            sep = ",")
#--------------------------------------------------------------------
table2_turnover <- table2[,c(1:4,12:20)]
